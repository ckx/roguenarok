...
enum e_skill {
	...
	// Start Roguenarok Skills Beginning at 1020.
	RGX_BOWMASTERY = 1020,
	RGX_DAGGERMASTERY = 1021,
	RGX_ADVSWORDMASTERY = 1022,
	RGX_ADV2HSMASTERY = 1023,
	RGX_ADVSPEARMASTERY = 1024,
	RGX_ADVAXEMASTERY = 1025,
	RGX_ADVBOOKMASTERY = 1026,
	RGX_ADVINSTRUMENTMASTERY = 1027,
	RGX_ADVCLAWMASTERY = 1028,
	RGX_ADVMACEMASTERY = 1029,
	RGX_ADVBOWMASTERY = 1030,
	RGX_ADVDAGGERMASTERY = 1031,
	RGX_ARMORMASTERYCLOTH = 1032,
	RGX_ARMORMASTERYLIGHT = 1033,
	RGX_ARMORMASTERYHEAVY = 1034,
	RGX_ADVSHIELDMASTERY = 1035,
	RGX_CHEMICALSKIN = 1036,
	RGX_BALLPITCHER = 1037,
	RGX_TESTSKILL = 1038,
