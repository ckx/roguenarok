				...
				if( sd->state.arrow_atk ) { // Ranged attack
					...
					switch(sd->status.weapon) {
						...
						case W_1HSWORD:
							...
							break;
						case W_2HSWORD:
							if((skill = pc_checkskill(sd,RGX_ADV2HSMASTERY)) > 0)
								cardfix = cardfix * (100 + (10 + 2 * skill)) / 100;
							break;
						case W_1HSPEAR:
						case W_2HSPEAR:
							if((skill = pc_checkskill(sd,RGX_ADVSPEARMASTERY)) > 0)
								cardfix = cardfix * (100 + (10 + 2 * skill)) / 100;
							break;
						case W_1HAXE:
						case W_2HAXE:
							if((skill = pc_checkskill(sd,RGX_ADVAXEMASTERY)) > 0)
								cardfix = cardfix * (100 + (10 + 2 * skill)) / 100;
							break;
						case W_MACE:
						case W_2HMACE:
							if((skill = pc_checkskill(sd,RGX_ADVMACEMASTERY)) > 0)
								cardfix = cardfix * (100 + (10 + 2 * skill)) / 100;
							break;
						case W_FIST:
						case W_KNUCKLE:
							if((skill = pc_checkskill(sd,RGX_ADVCLAWMASTERY)) > 0)
								cardfix = cardfix * (100 + (10 + 2 * skill)) / 100;
							break;
						case W_MUSICAL:
						case W_WHIP:
							if((skill = pc_checkskill(sd,RGX_ADVINSTRUMENTMASTERY)) > 0)
								cardfix = cardfix * (100 + (10 + 2 * skill)) / 100;
							break;
						case W_BOOK:
							if((skill = pc_checkskill(sd,RGX_ADVBOOKMASTERY)) > 0)
								cardfix = cardfix * (100 + (10 + 2 * skill)) / 100;
							break;
						case W_BOW:
							if((skill = pc_checkskill(sd,RGX_ADVBOWMASTERY)) > 0)
								cardfix = cardfix * (100 + (10 + 2 * skill)) / 100;
							break;
					}
