...
#define MAX_SKILL 5000 ///Maximum skill can be hold by Player, Homunculus, & Mercenary (skill list) AND skill_db limit
#define DEFAULT_WALK_SPEED 125 ///Default walk speed
...
#define MAX_PARTY 4 ///Max party member
